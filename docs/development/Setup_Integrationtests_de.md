...
**integrationTests/cypress.json** [[Link zur Datei](../../integrationTests/cypress.json)] <!-- markdown-link-check-disable-line -->
...
Änderungen außerhalb des dogu-Bereichs zu übernehmen, z. B. wenn sich CAS geändert hat.
